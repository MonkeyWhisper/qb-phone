...
-- for vehicles
RegisterNetEvent('qb-phone:server:updateVehicleState', function(state, plate, garage)
    ...
    for k, v in pairs(QBCore.Functions.GetPlayers()) do
        ...
        if Player ~= nil then
            if (Player.PlayerData.job.name == "lawyer" or Player.PlayerData.job.name == "realestate" or
                ...
                Player.PlayerData.job.name == "tunerheaven" or Player.PlayerData.job.name == "lombardi" or
                Player.PlayerData.job.name == "police" or Player.PlayerData.job.name == "ambulance") then --and
...
QBCore.Commands.Add('bill', 'Bill A Player', {{name = 'id', help = 'Player ID'}, {name = 'amount', help = 'Fine Amount'}}, false, function(source, args)
    ...
    if biller.PlayerData.job.name == "police" or biller.PlayerData.job.name == 'ambulance' or biller.PlayerData.job.name == 'mechanic' or biller.PlayerData.job.name == 'tunerheaven' or biller.PlayerData.job.name == 'pizza' or biller.PlayerData.job.name == 'lockers' then
        if billed ~= nil then
